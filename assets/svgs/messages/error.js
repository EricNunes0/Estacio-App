...
export default function MessageErrorSVG() {
    return (
        <Svg xmlns="http://www.w3.org/2000/svg" fill="#ba3025" width="20px" height="20px" viewBox="-1.7 0 20.4 20.4" class="cf-icon-svg">
